...
func example(cfg *ini.File) {
	...
	_, _ = cfg.Section("SectionName").Key("KeyName").StrictFloat64s(",")
	_, _ = cfg.Section("SectionName").Key("KeyName").StrictInts(",")
	_, _ = cfg.Section("SectionName").Key("KeyName").StrictInt64s(",")
	_, _ = cfg.Section("SectionName").Key("KeyName").StrictUints(",")
	_, _ = cfg.Section("SectionName").Key("KeyName").StrictUint64s(",")
	_, _ = cfg.Section("SectionName").Key("KeyName").StrictTimes(",")
}
